...
class DetailsScreenAdmin extends StatefulWidget {
  final ProductData productData;

  const DetailsScreenAdmin({super.key, required this.productData});

  @override
  DetailsScreenAdminState createState() => DetailsScreenAdminState();
}
